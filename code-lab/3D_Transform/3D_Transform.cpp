...
int main(int argc, char *argv)
{
    ...
    {
    case 1:
        printf("Nhap do dai tinh tien cua X, Y & Z\n=>");
    ...
    case 2:
        ...
        break;
    case 3:
        printf("Nhap ti le X, Y & Z\n=>");
        scanf("%f%f%f", &ScaleX, &ScaleY, &ScaleZ);
        break;
    case 4:
        printf("Xoay quanh truc:\n1.Song song voi truc X.(y=B & z=C)\n2.Song song voi truc Y.(x=A & z=C)\n3.Song song voi truc Z.(x=A & y=B)\n4.Dong tuy chon, di qua (x1,y1,z1) & (x2,y2,z2)\n =>");
        ...
        case 3:
            ...
            break;
        case 4:
            printf("Nhap x1 ,y1 & z1:\n");
            scanf("%f %f %f", &x1, &y11, &z1);
            printf("Nhap x2 ,y2 & z2:\n");
