...
float vertices2[] = {1.5-1.8, 1.5, 0-1.8, 1.5, 0-1.8, 0, 1.5-1.8, 0};
...
{
	glBegin(GL_POLYGON);		
		glVertex2f(vertices2[0], vertices2[1]);
		glVertex2f(vertices2[2], vertices2[3]);
		glVertex2f(vertices2[4], vertices2[5]);
		glVertex2f(vertices2[6], vertices2[7]);
	glEnd();
	glFlush();
}
...
void rotate(float heso)
{
	...
	vertices2[0]= vertices2[0] * cos(heso*(M_1_PI/180)) - vertices[1] * sin(heso*(M_1_PI/180));
	vertices2[2]= vertices2[2] * cos(heso*(M_1_PI/180)) - vertices[3] * sin(heso*(M_1_PI/180));
	vertices2[4]= vertices2[4] * cos(heso*(M_1_PI/180)) - vertices[5] * sin(heso*(M_1_PI/180));
	vertices2[6]= vertices2[6] * cos(heso*(M_1_PI/180)) - vertices[7] * sin(heso*(M_1_PI/180));

	vertices2[1]= vertices2[0] * sin(heso*(M_1_PI/180))+ vertices[1] * cos(heso*(M_1_PI/180));
	vertices2[3]= vertices2[2] * sin(heso*(M_1_PI/180))+ vertices[3] * cos(heso*(M_1_PI/180));
	vertices2[5]= vertices2[4] * sin(heso*(M_1_PI/180))+ vertices[5] * cos(heso*(M_1_PI/180));
	vertices2[7]= vertices2[6] * sin(heso*(M_1_PI/180))+ vertices[7] * cos(heso*(M_1_PI/180));
...
void changeY(float heso_tinh_tien)  //Tinh tien theo truc Y
{
	...
	vertices2[0] -= heso_tinh_tien;
	vertices2[2] -= heso_tinh_tien;
	vertices2[4] -= heso_tinh_tien;
	vertices2[6] -= heso_tinh_tien;
...
void changeX(float heso_tinh_tien)  //Tinh tien theo truc X
{
	...
	vertices2[1] += heso_tinh_tien;
	vertices2[3] += heso_tinh_tien;
	vertices2[5] += heso_tinh_tien;
	vertices2[7] += heso_tinh_tien;
